...
// Helper to parse configuration from process.env or .env file
function getEnvConfig() {
  const config = {
    aptKey: process.env.KEY || null,
    kakaoRestKey: process.env.REST_API_KEY || null,
    kakaoJsKey: process.env.JS_KEY || null
  };

  // Fallback to local .env if it exists (for local testing of serverless functions)
  try {
